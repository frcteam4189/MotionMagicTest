...
import frc.robot.commands.DumpBackUp;
...
public class RobotContainer {
  ...
  public RobotContainer() {
    ...
    autoChooser.addOption("Dump Ball Auto", new DumpBackUp(mDriveTrain, mDumpMechanism));
  ...
  private void configureButtonBindings() {
    ...
    final JoystickButton testDriveTrainMM = new JoystickButton(mDriveController, Button.kStart.value);
    testDriveTrainMM.whenPressed(new DriveToDistanceMotionMagic(mDriveTrain, 50, mDumpMechanism));
