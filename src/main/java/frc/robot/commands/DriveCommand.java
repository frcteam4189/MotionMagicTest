...
public class DriveCommand extends CommandBase {
  ...
  public void execute() {
    ...
    if(mDriveController.getBumper(Hand.kRight)){
      mDriveTrain.openLoopControl(-yAxis, xAxis*.7);
      mDriveController.setRumble(RumbleType.kLeftRumble, .5);
      mDriveController.setRumble(RumbleType.kRightRumble, .5);
    }
    else{
      mDriveTrain.openLoopControl(-yAxis*.7, xAxis*.6);
      mDriveController.setRumble(RumbleType.kLeftRumble, 0);
      mDriveController.setRumble(RumbleType.kRightRumble, 0);
    }
